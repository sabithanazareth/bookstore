...
$pswd = $_POST["pwd"];
if( $pswd!=""){
  $query = $mysqli->query("UPDATE `login` SET pwd ='". $pswd ."' WHERE email ='{$_SESSION['email']}'");
        ...
        <div class="small-12">
          ...
          <div class="row">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                $result = $mysqli->query("SELECT * FROM `login` WHERE email='{$_SESSION['email']}'");
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" name="update" value="Update" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
